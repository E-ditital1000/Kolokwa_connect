...
try:
    ...
    # This file is at: kolokwa/src/kolokwa_mcp/run_dictionary_server.py
    ...
    # Register all the dictionary server functions
    import importlib.util
    spec = importlib.util.spec_from_file_location(
        "dict_server_defs",
        current_file.parent / "dictionary_server.py"
    )
    dict_server_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(dict_server_module)
