...
try:
    ...
    print(f"Tools: {len(dictionary_server.mcp.list_tools())}", file=sys.stderr)
    print(f"Resources: {len(dictionary_server.mcp.list_resources())}", file=sys.stderr)
    print("Ready for Claude Desktop", file=sys.stderr)
    
    sys.stdout = original_stdout
    dictionary_server.mcp.run()
